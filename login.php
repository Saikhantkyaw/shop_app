...
require("connection/config.php");
 ...
 if ($_POST) {
   ...
   $statment->blindValue(':email',$email);
   $statment->execute();
   ...
   if ($user) {
    ...
    $_SESSION['username']=$user['name'];
 	...
 	echo "<script>alert('You need to register:((');</script>";
 }
}
					...
					<div class="login_form_inner">
						...
						<form class="row login_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" name="email" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
							</div>
							<div class="col-md-12 form-group">
