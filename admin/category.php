<?php 
 ...
 ?>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"></h3><br>
                 <a href="cat_add.php" class="btn btn-info"> new category post</a>
              </div>
              <?php 
    ...
    $statment= $pdo->prepare("SELECT * FROM categories ORDER BY id DESC LIMIT $offset,$noOfrec");
              $statment->execute();
  ...
  $statment= $pdo->prepare("SELECT * FROM categories WHERE name LIKE '%$searchkey%'  ORDER BY id DESC");
              $statment->execute();
              $rawResult=$statment->FETCHALL();
              $total_pages=ceil(count($rawResult)/$noOfrec);

$statment= $pdo->prepare("SELECT * FROM categories WHERE name LIKE '%$searchkey%' ORDER BY id DESC LIMIT $offset,$noOfrec");
                ...
                {$i=1;
                  ...
                  {?>
                    ...
                    <td style ="width:450px;"> 
                      <?php echo substr(mo( $value['description']),0,50) ;?>
                      ...
                      <a href="cat_edit.php?id=<?php echo $value['id']; ?>"  class="btn btn-warning">Edit</a></div><br>
                      <div>
