<?php 
 ...
 if ($_POST) 
 {
  ...
  $statment=$pdo->prepare('INSERT INTO categories(name,description) VALUES (:name,:description)');
  ...
  if ($result) {
    echo "<script>alert('your category is added');window.location.href='category.php'</script>";
  }
  }
 }
